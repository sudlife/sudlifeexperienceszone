      ...
      case AppLifecycleState.resumed:
        if (!_timer.isActive) {
          setState(() {
            ...
            diff = timeOfActivationInResume
                .difference(timeOfActivationInBackground);
          });
          print("${diff.inSeconds} in seconds");
          print("${diff.inMinutes} in minutes");
